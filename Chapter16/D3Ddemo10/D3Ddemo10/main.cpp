...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	wndClass.hIcon = (HICON)::LoadImage(NULL, L"../../../../resource/Chapter16/D3Ddemo11/icon.ico", IMAGE_ICON, 0, 0, LR_DEFAULTSIZE | LR_LOADFROMFILE);  //本地加载自定义ico图标
	...
	PlaySound(L"../../../../resource/Chapter16/D3Ddemo11/仙剑·商店购物", NULL, SND_FILENAME | SND_ASYNC | SND_LOOP); //循环播放背景音乐 
...
HRESULT Objects_Init()
{
	...
	// 【纹理绘制四步曲之三】：纹理的创建
	//--------------------------------------------------------------------------------------
	D3DXCreateTextureFromFileEx(g_pd3dDevice, L"../../../../resource/Chapter16/D3Ddemo11/pal5q.jpg", 0, 0, 6, 0, D3DFMT_X8R8G8B8,
