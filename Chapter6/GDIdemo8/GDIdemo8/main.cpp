...
HBITMAP	g_hSprite = NULL, g_hBackGround = NULL;//定义三个位图句柄，用于3张图片存放
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	PlaySound(L"../../../../resource/Chapter6/GDIdem8/仙剑三·原版景天.wav", NULL, SND_FILENAME | SND_ASYNC | SND_LOOP); //循环播放背景音乐 
...
{
	//处理图号
	if (g_iNum == 8)               //判断是否超过最大图号，若超过最大图号“12”，则将显示图号重设为"0"。
		g_iNum = 0;
