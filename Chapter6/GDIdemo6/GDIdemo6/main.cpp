...
HBITMAP	g_hSprite[12]; //定义三个位图句柄，用于3张图片存放
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	wndClass.hIcon = (HICON)::LoadImage(NULL, L"../../../../resource/Chapter6/GDIdemo6/icon.ico", IMAGE_ICON, 0, 0, LR_DEFAULTSIZE | LR_LOADFROMFILE);  //本地加载自定义ico图标
	...
	PlaySound(L"../../../../resource/Chapter6/GDIdemo6/鸟之诗.wav", NULL, SND_FILENAME | SND_ASYNC | SND_LOOP); //循环播放背景音乐 
...
BOOL Game_Init(HWND hwnd)
{
	...
	wchar_t filename[180];

	//载入各个萝莉位图
	for (int i = 0; i < 12; i++)
	{
		memset(filename, 0, sizeof(filename));  //filename的初始化
		swprintf_s(filename, L"../../../../resource/Chapter6/GDIdemo6/%d.bmp", i);  //调用swprintf_s函数，“组装”出对应的图片文件名称
