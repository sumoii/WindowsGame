...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	wndClass.hIcon = (HICON)::LoadImage(NULL, L"../../../../resource/Chapter6/GDIdemo7/icon.ico", IMAGE_ICON, 0, 0, LR_DEFAULTSIZE | LR_LOADFROMFILE);  //本地加载自定义ico图标
...
BOOL Game_Init(HWND hwnd)
{
	...
	for (int i = 0; i < 12; i++)
	{
		...
		swprintf_s(filename, L"../../../../resource/Chapter6/GDIdemo7/%d.bmp", i);  //调用swprintf_s函数，“组装”出对应的图片文件名称
