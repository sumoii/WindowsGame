...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	wndClass.hIcon = (HICON)::LoadImage(NULL, L"../../../../resource/Chapter15/D3Ddemo8/icon.ico", IMAGE_ICON, 0, 0, LR_DEFAULTSIZE | LR_LOADFROMFILE);  //本地加载自定义ico图标
	...
	PlaySound(L"../../../../resource/Chapter15/D3Ddemo8/刻限.wav", NULL, SND_FILENAME | SND_ASYNC | SND_LOOP); //循环播放背景音乐 
...
HRESULT Objects_Init(HWND hwnd)
{
	...
	D3DXLoadMeshFromX(L"../../../../resource/Chapter15/D3Ddemo8/loli.x", D3DXMESH_MANAGED, g_pd3dDevice,
