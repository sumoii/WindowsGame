...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	wndClass.hIcon = (HICON)::LoadImage(NULL, L"../../../../resource/Chapter20/D3Ddemo15/icon.ico", IMAGE_ICON, 0, 0, LR_DEFAULTSIZE | LR_LOADFROMFILE);  //本地加载自定义ico图标
	...
	PlaySound(L"../../../../resource/Chapter20/D3Ddemo15/仙剑·战斗3.wav", NULL, SND_FILENAME | SND_ASYNC | SND_LOOP); //循环播放背景音乐 
...
HRESULT Objects_Init(HWND hwnd)
{
	...
	D3DXLoadMeshFromX(L"../../../../resource/Chapter20/D3Ddemo15/lighting.X", D3DXMESH_MANAGED, g_pd3dDevice,
	...
	for (DWORD i = 0; i < g_dwNumMtrls; i++)
	{
		...
		//创建一下纹理对象
		g_pTextures[i] = NULL;
		wchar_t TempName[180] = L"../../../../resource/Chapter20/D3Ddemo15/";
...
void Matrix_Set()
{
	...
	D3DXVECTOR3 vEye(0.0f, 150.0f, -250.0f);  //摄像机的位置
