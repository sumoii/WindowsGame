...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	wndClass.hIcon = (HICON)::LoadImage(NULL, _T("../../../../resource/Chapter11/D3Ddemo2/icon.ico"), IMAGE_ICON, 0, 0, LR_DEFAULTSIZE | LR_LOADFROMFILE);  //本地加载自定义ico图标
	...
	PlaySound(_T("../../../../resource/Chapter11/D3Ddemo2/Final Fantasy XIII.wav"), NULL, SND_FILENAME | SND_ASYNC | SND_LOOP); //循环播放背景音乐 
	...
	//【6】窗口类的注销
	UnregisterClass(_T("ForTheDreamOfGameDevelop"), wndClass.hInstance);  //程序准备结束，注销窗口类
	return 0;
}
