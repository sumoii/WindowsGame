...
int		g_iX = 0, g_iY = 0, g_iXSpeed = 0, g_iYSpeed = 0, g_iYGravity = 0;  //g_iX,g_iY代表贴图位置，g_iXSpeed,g_iYSpeed表示X分量和Y分量上的速度 g_iYGravity加速度
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	wndClass.hIcon = (HICON)::LoadImage(NULL, L"../../../../resource/Chapter8/GDIdemo12/icon.ico", IMAGE_ICON, 0, 0, LR_DEFAULTSIZE | LR_LOADFROMFILE);  //本地加载自定义ico图标
	...
	PlaySound(L"../../../../resource/Chapter8/GDIdemo12/カブラ樹林.wav", NULL, SND_FILENAME | SND_ASYNC | SND_LOOP); //循环播放背景音乐 
