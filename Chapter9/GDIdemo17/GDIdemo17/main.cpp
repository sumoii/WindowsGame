...
wchar_t text[8][100]; //存储着输出文字的字符串数值
BOOL g_bCanAttack, g_bGameOver;//两个游戏状态标识，角色是否可以攻击，游戏是否结束
SNOW SnowFlowers[PARTICLE_NUMBER];//雪花粒子数值
CHARACTER Hero, Boss;					//两个角色结构体实列，分别表示英雄和BOSS
ActionTypes HeroActionType, BossActionType; //两个动作类型枚举实，
int					g_SnowNum = 0; //定于计数雪花
//一系列位图句柄的定义
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	wndClass.hIcon = (HICON)::LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/icon.ico", IMAGE_ICON, 0, 0, LR_DEFAULTSIZE | LR_LOADFROMFILE);  //本地加载自定义ico图标
	...
	MoveWindow(hwnd, 250, 80, WINDOW_WIDTH, WINDOW_HEIGHT, true);		//调整窗口显示时的位置，使窗口左上角位于（150,20）处
	...
	PlaySound(L"../../../../resource/Chapter9/GDIdemo17/梦幻西游原声-战斗1-森林.wav", NULL, SND_FILENAME | SND_ASYNC | SND_LOOP); //循环播放背景音乐 
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_DESTROY:					//若是窗口销毁消息
		Game_ShutDown(hwnd);			//调用自定义的资源清理函数Game_CleanUp（）进行退出前的资源清理
...
BOOL Game_Init(HWND hwnd)
{
	...
	//载入位图背景
	g_hBackGround = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/bg.bmp", IMAGE_BITMAP, 800, 600, LR_LOADFROMFILE);	//背景位图
	g_hGameOver = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/gameover.bmp", IMAGE_BITMAP, 1086, 396, LR_LOADFROMFILE); //游戏结束位图
	g_hVictory = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/victory.bmp", IMAGE_BITMAP, 800, 600, LR_LOADFROMFILE); //游戏胜利位图
	g_hMonsterBitmap = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/monster.bmp", IMAGE_BITMAP, 360, 360, LR_LOADFROMFILE);  //怪物角色位图
	g_hHeroBitmap = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/hero.bmp", IMAGE_BITMAP, 360, 360, LR_LOADFROMFILE); //英雄角色位图
	g_hHeroSkill1 = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/heroslash.bmp", IMAGE_BITMAP, 364, 140, LR_LOADFROMFILE);  //英雄1技能位图
	g_hHeroSkill2 = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/heromagic.bmp", IMAGE_BITMAP, 374, 288, LR_LOADFROMFILE);  //英雄2技能位图
	g_hHeroSkill3 = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/herocritical.bmp", IMAGE_BITMAP, 574, 306, LR_LOADFROMFILE);  //英雄3技能位图
	g_hSkillButton1 = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/skillbutton1.bmp", IMAGE_BITMAP, 50, 50, LR_LOADFROMFILE);  //技能1图标位图
	g_hSkillButton2 = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/skillbutton2.bmp", IMAGE_BITMAP, 50, 50, LR_LOADFROMFILE);   //技能2图标位图
	g_hSkillButton3 = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/skillbutton3.bmp", IMAGE_BITMAP, 50, 50, LR_LOADFROMFILE);   //技能3图标位图
	g_hSkillButton4 = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/skillbutton4.bmp", IMAGE_BITMAP, 50, 50, LR_LOADFROMFILE);   //技能4图标位图
	g_hBossSkill1 = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/monsterslash.bmp", IMAGE_BITMAP, 234, 188, LR_LOADFROMFILE);   //怪物1技能位图
	g_hBossSkill2 = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/monstermagic.bmp", IMAGE_BITMAP, 387, 254, LR_LOADFROMFILE);  //怪物2技能位图
	g_hBossSkill3 = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/monstercritical.bmp", IMAGE_BITMAP, 574, 306, LR_LOADFROMFILE); //怪物3技能位图
	g_hSnow = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/snow.bmp", IMAGE_BITMAP, 30, 30, LR_LOADFROMFILE);   //雪花位图
	g_hRecoverSkill = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter9/GDIdemo17/recover.bmp", IMAGE_BITMAP, 150, 150, LR_LOADFROMFILE);    //恢复技能位图
...
VOID Die_Check(int NowHp, bool isHero)
{
	...
	{
		g_bGameOver = true;
		if (isHero) //如果是英雄的生命值小于0,表示游戏失败
		{
			PlaySound(L"../../../../resource/Chapter9/GDIdemo17/failure.wav", NULL, SND_FILENAME | SND_ASYNC);//播放失败音乐
			swprintf_s(str, L":(胜败乃兵家常事，大侠请重新来过......");//输出失败提示语
			Message_Insert(str);//插入到文字消息中
		}
		else
		{
			PlaySound(L"../../../../resource/Chapter9/GDIdemo17/victory.wav", NULL, SND_FILENAME | SND_ASYNC);//播放胜利音乐
