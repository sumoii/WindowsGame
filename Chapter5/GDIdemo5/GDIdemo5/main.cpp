...
#define WINDOW_HEIGHT	721							//为窗口高度定义的宏，以方便在此处修改窗口高度
...
HBITMAP	g_hBackGround, g_hSprite1, g_hSprite2; //定义三个位图句柄，用于3张图片存放
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	wndClass.hIcon = (HICON)::LoadImage(NULL, L"../../../../resource/Chapter5/GDIdemo5/icon.ico", IMAGE_ICON, 0, 0, LR_DEFAULTSIZE | LR_LOADFROMFILE);  //本地加载自定义ico图标
	...
	PlaySound(L"../../../../resource/Chapter5/GDIdemo5/サンレス水郷.wav", NULL, SND_FILENAME | SND_ASYNC | SND_LOOP); //循环播放背景音乐 
...
VOID Game_Paint(HWND hwnd)
{
	...
	TransparentBlt(g_hdc, 535, WINDOW_HEIGHT - 650, 506, 650, g_mdc, 0, 0, 506, 650, RGB(0, 0, 0));//透明色为RGB（0，0，0）
}
