...
HBITMAP	g_hBackGround, g_hCharacter1, g_hCharacter2; //定义三个位图句柄，用于3张图片存放
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	wndClass.hIcon = (HICON)::LoadImage(NULL, L"../../../../resource/Chapter5/GDIdemo4/icon.ico", IMAGE_ICON, 0, 0, LR_DEFAULTSIZE | LR_LOADFROMFILE);  //本地加载自定义ico图标
	...
	PlaySound(L"../../../../resource/Chapter5/GDIdemo4/宝瓶时代1.wav", NULL, SND_FILENAME | SND_ASYNC | SND_LOOP); //循环播放背景音乐 
...
BOOL Game_Init(HWND hwnd)
{
	...
	//-----【位图绘制四步曲之一：加载位图】-----
	//从文件加载3张位图
	g_hBackGround = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter5/GDIdemo4/bg.bmp", IMAGE_BITMAP, WINDOW_WIDTH, WINDOW_HEIGHT, LR_LOADFROMFILE);
	g_hCharacter1 = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter5/GDIdemo4/character1.bmp", IMAGE_BITMAP, 640, 579, LR_LOADFROMFILE);
	g_hCharacter2 = (HBITMAP)LoadImage(NULL, L"../../../../resource/Chapter5/GDIdemo4/character2.bmp", IMAGE_BITMAP, 800, 584, LR_LOADFROMFILE);
